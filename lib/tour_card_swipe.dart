...
import 'tour_swipelist/size_change_notifier.dart';
...
class TourCardSlide extends StatefulWidget {
  TourCardSlide({
    Key key,
    @required this.items,
    @required this.child,
  ...
  State<StatefulWidget> createState() {
    return _TourCardSlideState();
  }
}


class _TourCardSlideState extends State<TourCardSlide> {
